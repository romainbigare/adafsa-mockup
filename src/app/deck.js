...
const NOTES = {
  'crop/inventory': 'Shows what is planted and where. The numbers: farms with field crops, the area under them, how many different crops, and the average share of a farm. The table of farms has no total, because a farm growing three crops is counted three times. (Module 1: crop location, crop type, cultivated area.)',
  'crop/annuals': 'The crops that grow all year. Two stacked charts \u2014 cereals on the left, fodder on the right \u2014 over the last six quarters, in dunums. Six quarters shows both the quarter before and the same quarter last year. Below: every crop by quarter, then every farm, oldest figure first. (Module 1: cultivated area and seasonal change report.)',
  'crop/openfield': 'The vegetables, which are seasonal: planted from September and out of the ground by March. Area planted quarter by quarter on the left. On the right, which crops moved against the same quarter last year \u2014 or, when one crop is picked, who its biggest growers are. (Module 1: cultivated area and seasonal change report.)',
  'crop/fallow': 'Land that can be farmed, in three states: under cultivation, resting less than a year and waiting for a crop, and resting more than a year and not being used. Six quarters, stacked, with the year-on-year movement beside it. (Module 1: fallow land detection.)',
  'trees/inventory': 'Counts the trees: the total, date palms, fruit trees, forest trees, and how many palm varieties were found. The map counts farms until you zoom into one, and then draws every tree in the colour of its variety. (Module 2: tree location, count, species and variety.)',
  'trees/canopy': 'The canopy health index, read from the satellite and scored for each farm: the average for palms, the average for fruit trees, farms with stressed trees, and farms in the lowest band. Zoom in and the map reads the index closer in. (Module 2: canopy health index.)',
